...
namespace SystemePlacement.Web.Migrations
{
    ...
    [Migration("20260803223325_RefonteDomainesMultiColleges")]
    partial class RefonteDomainesMultiColleges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SystemePlacement.Web.Models.Candidature", b =>
                {
                    ...
                    b.Property<DateTime?>("DateConfirmationEmploi")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime?>("DateReponseEmployeur")
                        .HasColumnType("datetime(6)");

                    b.Property<bool>("EmploiConfirme")
                    ...
                    b.Property<string>("MessageConfirmationEmploi")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("SystemePlacement.Web.Models.CollegeDomaine", b =>
                {
                    b.Property<int>("IdCollegeDomaine")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("id_college_domaine");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("IdCollegeDomaine"));
                    ...
                    b.HasKey("IdCollegeDomaine");

                    b.HasIndex("IdDomaine");

                    b.HasIndex("IdCollege", "IdDomaine")
                        .IsUnique();

                    b.ToTable("college_domaines", (string)null);
                });
            ...
            modelBuilder.Entity("SystemePlacement.Web.Models.Recommandation", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("IdRecommandation"));

                    b.Property<string>("CheminLettreRecommandation")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)")
                    ...
                    b.Property<string>("ContentTypeLettre")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)")
                    ...
                    b.Property<int?>("IdEmployeurDestinataire")
                        .HasColumnType("int")
                    ...
                    b.Property<string>("NomFichierLettre")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)")
            ...
            modelBuilder.Entity("SystemePlacement.Web.Models.Recommandation", b =>
                {
                    b.HasOne("SystemePlacement.Web.Models.Utilisateur", "Auteur")
                        .WithMany()
                        .HasForeignKey("IdAuteur")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SystemePlacement.Web.Models.Employeur", "EmployeurDestinataire")
                        .WithMany()
                        .HasForeignKey("IdEmployeurDestinataire")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("EmployeurDestinataire");
